    ...
    <footer className="bg-slate-950 border-t border-cyan-glow/10 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="mailto:contact@bubble.ai" className="p-2 bg-white/5 rounded-full hover:bg-cyan-glow hover:text-navy-dark transition-all duration-300">
                <Mail size={20} />
              </a>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500">
          <p>© 2024 Bubble Robotics. AI Powered Environmental Solutions.</p>
